...
cor.test(~ avg_walk_ind + pct_asthma, data = data)

age_model <- lm(avg_walk_ind ~ pct_asthma, data = data)
...
ggplot(data) +
  geom_point(aes(x = avg_walk_ind, y = pct_asthma)) +
  geom_smooth(aes(x = avg_walk_ind, y = pct_asthma), color = 'red', method = 'lm', se = FALSE) +
...
cor.test(~ avg_walk_ind + pct_obesity, data = data)

age_model <- lm(avg_walk_ind ~ pct_obesity, data = data)
...
ggplot(data) +
  geom_point(aes(x = avg_walk_ind, y = pct_obesity)) +
  geom_smooth(aes(x = avg_walk_ind, y = pct_obesity), color = 'red', method = 'lm', se = FALSE) +
  labs(x = "Walkability Score", 
...
cor.test(~ avg_walk_ind + pct_mental, data = data)

age_model <- lm(avg_walk_ind ~ pct_mental, data = data)
...
ggplot(data) +
  geom_point(aes(x = avg_walk_ind, y = pct_mental)) +
  geom_smooth(aes(x = avg_walk_ind, y = pct_mental), color = 'red', method = 'lm', se = FALSE) +
  labs(x = "Walkability Score", 
...
cor.test(~ avg_walk_ind + pct_walk, data = data)

age_model <- lm(avg_walk_ind ~ pct_walk, data = data)
...
ggplot(data) +
  geom_point(aes(x = avg_walk_ind, y = pct_walk)) +
  geom_smooth(aes(x = avg_walk_ind, y = pct_walk), color = 'red', method = 'lm', se = FALSE) +
  labs(x = "Walkability Score", 
...
cor.test(~ avg_walk_ind + pct_bike, data = data)

age_model <- lm(avg_walk_ind ~ pct_bike, data = data)
...
ggplot(data) +
  geom_point(aes(x = avg_walk_ind, y = pct_bike)) +
  geom_smooth(aes(x = avg_walk_ind, y = pct_bike), color = 'blue', method = 'lm', se = FALSE) +
  labs(x = "Walkability Score", 
...
cor.test(~ avg_walk_ind + pct_public, data = data)

age_model <- lm(avg_walk_ind ~ pct_public, data = data)
...
ggplot(data) +
  geom_point(aes(x = avg_walk_ind, y = pct_public)) +
  geom_smooth(aes(x = avg_walk_ind, y = pct_public), color = 'green', method = 'lm', se = FALSE) +
  labs(x = "Walkability Score", 
...
cor.test(~ avg_walk_ind + pct_car, data = data)

age_model <- lm(avg_walk_ind ~ pct_car, data = data)
...
ggplot(data) +
  geom_point(aes(x = avg_walk_ind, y = pct_car)) +
  geom_smooth(aes(x = avg_walk_ind, y = pct_car), color = 'orange', method = 'lm', se = FALSE) +
  labs(x = "Walkability Score", 
...
### Sex_majority
```{r}
sex_model <- lm(avg_walk_ind ~ sex_majority, data = my_data)
...
### Race_majority
```{r}
race_model <- lm(avg_walk_ind ~ race_majority, data = my_data)
...
```{r}
full_model <- lm(avg_walk_ind ~ pct_asthma + pct_obesity + pct_mental + pct_walk + pct_bike + pct_public + pct_car, my_data)
